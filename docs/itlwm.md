...
You don't need root patching. You can reenable macOS security measures using this guide: [I don't need root patching](./docs/amfi.md). After you're done, return here and follow the steps below.
